        ...
        <header>
            ...
            <div class="navigation-container">
                ...
                <div class="meta-badges" id="dynamic-nav-badges">
                    ...
                    <a href="Learning_History/concept_priority.html" class="badge priority-badge" style="text-decoration: none; background: linear-gradient(135deg, #ef4444 0%, #b91c1c 100%); color: #ffffff; border: none; font-weight: 700;">🎯 개념 우선순위</a>
