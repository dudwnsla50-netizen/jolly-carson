...
def run_extraction_and_mapping():
    ...
    print("[1/3] PM 기출문제 PDF 파싱 및 전체 문항 DB 구축 중...")
...
def main():
    ...
    local_path = r"e:\jolly-carson\reports\pm_frequent_concepts.html"
    ...
    # 2. 아티팩트 디렉토리에 파일 저장
    artifact_path = r"C:\Users\DCCIS040000\.gemini\antigravity-ide\brain\7e1fd111-1dc1-495d-82a1-c40573600184\pm_frequent_concepts.html"
