...
def run_extraction_and_mapping():
    ...
    for exam in EXAM_FILES:
        ...
        try:
            ...
            # [설계 의도] 연도별 보안(SC) 실제 범위(101~120번 등)를 동적으로 반영하여 루프를 순회합니다.
            s_range = image_cropper.get_subject_range("SC", year)
...
def main():
    ...
    local_path = r"e:\jolly-carson\reports\sc_official_scopes.html"
    os.makedirs(os.path.dirname(local_path), exist_ok=True)
    with open(local_path, "w", encoding="utf-8") as f:
        f.write(html_content)
    print(f"[2/3] 로컬 reports 폴더 저장 완료: {local_path}")
    
    artifact_path = r"C:\Users\DCCIS040000\.gemini\antigravity-ide\brain\7e1fd111-1dc1-495d-82a1-c40573600184\sc_official_scopes.html"
